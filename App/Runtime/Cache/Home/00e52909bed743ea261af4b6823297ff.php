...
<head>
    ...
    <!--Required libraries-->
    <script src="/Lensent/Public/js/modernizr-custom-v2.7.1.min.js" type="text/javascript"></script>
    <script src="/Lensent/Public/js/jquery-finger-v0.1.0.min.js" type="text/javascript"></script>
    <!--Include flickerplate-->
    <script src="/Lensent/Public/js/flickerplate.min.js" type="text/javascript"></script>
...
<body>
    ...
    <div class="main-back">
        <div class="flicker-example banner-container" data-block-text="false">
            <ul>
                <li data-background="/Lensent/Public/images/1.jpg"></li>
                <li data-background="/Lensent/Public/images/2.jpg"></li>
                <li data-background="/Lensent/Public/images/3.jpg">
                    <div class="flick-title flick-title3">
                        <img src="/Lensent/Public/images/display_standard_large.png" alt="">
                    </div>
                    <div class="flick-sub-text flick-sub-text3">
                        <img src="/Lensent/Public/images/ico.png" height="100" width="100" alt="">
                        <img src="/Lensent/Public/images/logo.png" height="70" width="98" alt="">
                        <h2>一款来源于生活的极致APP</h2>
                        <a href="project.html">了解更多</a>
                    </div>
                    <div style="clear: both"></div>
                </li>
                <li data-background="/Lensent/Public/images/4.jpg">
                    <div class="flick-title flick-title4">
                        <img src="/Lensent/Public/images/4-1.png" alt="">
                    </div>
                </li>
            </ul>
        </div>
