...
<body class=" theme-blue">
  ...
  <!--<![endif]-->
    ...
    <div class="content">
       ...
       <script type="text/javascript" src="/Lensent/Admin/Public/utf8-php/ueditor.config.js"></script>
<script type="text/javascript" src="/Lensent/Admin/Public/utf8-php/ueditor.all.min.js"></script>
<script type="text/javascript" src="/Lensent/Admin/Public/utf8-php/lang/zh-cn/zh-cn.js"></script>
<link rel="stylesheet" href="/Lensent/Admin/Public/css/jquery.fileupload.css">
<link rel="stylesheet" href="/Lensent/Admin/Public/css/jquery.fileupload-ui.css">
<!--<script src="/Lensent/Admin/Public/js/jquery.min.js"></script>-->
<script src="/Lensent/Admin/Public/js/vendor/jquery.ui.widget.js"></script>
<script src="/Lensent/Admin/Public/js/jquery.fileupload.js"></script>
<script src="/Lensent/Admin/Public/js/jquery.iframe-transport.js"></script>
<!--引入CSS-->
<link rel="stylesheet" type="text/css" href="/Lensent/Admin/Public/webuploader-0.1.5/webuploader.css">
<!--引入JS-->
<script type="text/javascript" src="/Lensent/Admin/Public/webuploader-0.1.5/webuploader.js"></script>
  ...
  <div class="col-md-4">
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
          ...
          <div class="form-group">
              <label>时间</label>
              <input type="text" name="time" value="<?php echo ($list[0]["time"]); ?>" class="form-control">
          </div>
          <div class="form-group">
              <label>地点</label>
              <input type="text" name="place" value="<?php echo ($list[0]["place"]); ?>" class="form-control">
          </div>
            <div class="form-group">
              <label>内容</label>
              <textarea rows="15" name="content" id="myEditor"  style="width:1000px;height:480px;"><?php echo ($list[0]["content"]); ?></textarea>
                <script type="text/javascript">
                    //实例化编辑器
...
<script type="text/javascript">
    jQuery(function() {
        ...
        uploader = WebUploader.create({
            ...
            // swf文件路径
            swf: '/Lensent/Admin/Public/webuploader-0.1.5/Uploader.swf',

            // 文件接收服务端。
            server: '/Lensent/Admin/Public/webuploader-0.1.5/fileupload.php',
        ...
        uploader.on('uploadSuccess', function(file,ret) {
            ...
            var url = ret.url;
            url=url.replace('\\',"/")
            $('#firstphopo').attr("src","/Lensent/Admin/Public/webuploader-0.1.5/" + url);
            $('#temp').attr('value', "/Lensent/Admin/Public/webuploader-0.1.5/" + url);
        });
