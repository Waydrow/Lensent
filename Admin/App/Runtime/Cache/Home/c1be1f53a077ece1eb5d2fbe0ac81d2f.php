...
<body class=" theme-blue">
  ...
  <!--<![endif]-->
    ...
    <a href="<?php echo U("Home/Index/addAdmin");?>" class="btn btn-primary"><i class="fa fa-plus"></i> 新增管理员</a>
  <div class="btn-group">
  </div>
</div>
<table class="table">
  ...
  <tbody>
      ...
      <a href="<?php echo U("Home/Index/delAdmin?id=$vo[id]");?>" role="button" data-toggle="modal" onclick="del();"><i class="fa fa-trash-o"></i></a>
          </td>
