  ...
  <div class="col-md-4">
    ...
    <div id="myTabContent" class="tab-content">
      ...
      <form id="tab" method='post'>
        ...
        <div class="form-group">
          <label>职务</label>
          <textarea name="identity" id="identity" rows="3" class="form-control"><?php echo ($list[0]["identity"]); ?></textarea>
        </div>
        <div class="form-group">
          <label>部门</label>
          <textarea name="power" id="power" rows="3" class="form-control"><?php echo ($list[0]["power"]); ?></textarea>
        </div>
