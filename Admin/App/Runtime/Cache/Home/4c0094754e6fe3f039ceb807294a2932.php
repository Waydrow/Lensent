...
<table class="table">
  ...
  <tbody>
       <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td>
        <a href="<?php echo U("Home/Index/member?id=$vo[id]");?>"><i class="fa fa-pencil"></i></a>
      <a href="<?php echo U("Home/Index/delMember?id=$vo[id]");?>" role="button" data-toggle="modal" onclick="del();"><i class="fa fa-trash-o"></i></a>
          </td>
